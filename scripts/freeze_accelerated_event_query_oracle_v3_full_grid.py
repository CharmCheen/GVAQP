...
def seal() -> None:
    ...
    payload = self_hash({
        ...
        "fresh_execution_id": "AEQ_MODEL_RELATIVE_ORACLE_V3_FULL_GRID_FRESH_REVIEW_CORRECTIONS_V7",
        ...
        "full_grid_approval_scope": "the approval artifact for this seal authorizes only the exact 1,475-call full-grid execution",
        "separate_downstream_authorization": "the user's expanded 64 A100 GPU-hour research authorization is separate evidence and begins only after formal reference release",
