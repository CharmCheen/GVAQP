...
def seal() -> None:
    ...
    payload = self_hash({
        ...
        "fresh_execution_id": "AEQ_MODEL_RELATIVE_ORACLE_V3_FULL_GRID_FRESH_CONCURRENT_RESERVATION_V3",
...
def review_bundle() -> None:
    ...
    bundle = self_hash({
        ...
        "review_scope": [
            ...
            "65-second concurrent-tail-aware call reservation and nested prior failed-run evidence",
