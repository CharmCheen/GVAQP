# Strict Variant VLM Label Diagnostics

- VLM source file path: /qiuyeqing/llama_prl/G-ARC/test_vlm/outputs/kinematic_proxy/vlm_labels_strict_variants_exact_102.csv
...
- positive count: 96
- positive rate: 0.941
- label source mode: strict_variants
- ego-relevant label availability: True
- strict label availability: True (strict variants include pre-derived labels from exact VLM fields)
- high-confidence label availability: False (not used as a separate variant for strict-variant evaluation)
