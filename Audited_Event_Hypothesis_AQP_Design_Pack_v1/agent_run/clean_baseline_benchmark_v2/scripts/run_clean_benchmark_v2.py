...
def freeze_inputs() -> Frozen:
    ...
    oracle_cfg = json.loads((PACK / "oracle/oracle_configuration.json").read_text())
    ...
    compatibility.update({
        ...
        "processor_hash": oracle_cfg["processor_hash"],
        "video_processor_hash": oracle_cfg["video_processor_hash"],
        "generation_config_hash": oracle_cfg["generation_config_hash"],
    ...
    manifest = {
        ...
        "physical_hashes": {}, "oracle_cache": {"entries": len(oracle), "physical_calls_this_run": 1, "raw_cache_reused": 346, "new_raw_cache": 1},
    ...
    if run_dir.exists() and any(run_dir.iterdir()):
        ...
        if manifest_path.exists():
            ...
            if old.get("status") == "VALID" and old.get("benchmark_id") == frozen.benchmark_id and all(
                ...
                return run_dir
        raise FileExistsError(f"Refusing to overwrite invalid/nonempty run: {run_dir}")
