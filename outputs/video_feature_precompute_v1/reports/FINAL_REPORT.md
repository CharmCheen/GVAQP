# Video Feature Precompute v1 Final Report
...
- `elapsed_seconds`: `171.058`.
- `output_table_dir`: `/qiuyeqing/llama_prl/G-ARC/outputs/video_feature_precompute_v1/tables`.
- `score_timeline_figure`: `/qiuyeqing/llama_prl/G-ARC/outputs/video_feature_precompute_v1/figures/tables_score_timeline.svg`.
...
- Score timeline: `/qiuyeqing/llama_prl/G-ARC/outputs/video_feature_precompute_v1/figures/tables_score_timeline.svg`.
...
- Score quality report: `outputs/video_signal_quality_audit_v1/FINAL_REPORT.md`.
- `yolo_vehicle_max` top tie fraction: `0.141210`.
- Coarse 5s gap count: `0`; center10 gap count: `0`.
