...
- New event/K3/matching/state-boundary/oracle-schema/protocol tests: 49 passed with `PYTHONPATH=src pytest -q tests/accelerated_event_query`.
...
- second independent V2 implementation review of the repaired execution seal
