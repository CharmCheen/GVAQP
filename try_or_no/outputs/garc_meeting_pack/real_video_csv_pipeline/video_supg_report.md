...
| Item | Value |
|------|-------|
| Video path | `/qiuyeqing/llama_prl/G-ARC/try_or_no/test.mov` |
| Processed frames | 1775 |
| Frame stride | 1 |
| FPS | 41.24 |
| Duration | 43.1s |
| Frame dimensions | 2940x1912 |
...
|---|-----------------|-----------------|-----------------|----------------|
| 5 | 615 | 0.3465 | 220 | 0.1239 |
| 10 | 9 | 0.0051 | 0 | 0.0000 |
...
|---|----|----|----|----|-----------|--------|----|
| 5 | 199 | 21 | 416 | 1139 | 0.9045 | 0.3236 | 0.4766 |
| 10 | 0 | 0 | 9 | 1766 | 0.0000 | 0.0000 | 0.0000 |
| 20 | 0 | 0 | 0 | 1775 | 0.0000 | 0.0000 | 0.0000 |
...
|---|-------------|-------------|-------------|----------------|------|
| 5 | 4 | 1 | 0.0000 | 0.0000 | 0.0000 |
| 10 | 0 | 0 | 0.0000 | 0.0000 | 0.0000 |
...
This CSV is intended as input to later ARC-style and G-ARC experiments. ARC-style methods use proxy outputs to generate candidate clips and refine them with oracle calls, optimizing for candidate-side confidence. G-ARC's target is different: it seeks a clip-level recall certificate of the form Pr[ClipRecall >= gamma] >= 1 - delta, which audits possible missed clips rather than just validating returned candidates. The current YOLOv8n/YOLOv8x experiment only validates the existence of a proxy/pseudo-oracle quality gap on real video. It is not an ARC reproduction and not a G-ARC implementation.
